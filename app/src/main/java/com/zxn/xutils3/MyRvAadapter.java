...
class MyRvAadapter extends RecyclerView.Adapter<MyViewHolder> {

    private List<NewsInfo.ParamzBean.FeedsBean> mFeedsBeanList;
    private ImageOptions imageOptions;
    private String TAG = "MyRvAadapter";

    public MyRvAadapter(List<NewsInfo.ParamzBean.FeedsBean> feedsBeanList) {
...
//                .setParamsBuilder(ParamsBuilder paramsBuilder) //在网络请求中添加一些参数
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        NewsInfo.ParamzBean.FeedsBean bean = mFeedsBeanList.get(position);
        holder.tv_title.setText(bean.getData().getSubject());
        holder.tv_content.setText(bean.getData().getSummary());
        String url = "http://litchiapi.jstv.com".concat(bean.getData().getCover());
        //加载网络图片
